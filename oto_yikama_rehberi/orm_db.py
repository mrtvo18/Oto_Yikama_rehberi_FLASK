...
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///rehber_otomasyon_sistemi.db'
...
class Isyeri(db.Model):
    ...
    isyeri_puani = db.Column(db.Integer,nullable=False, default=0)
    isyeri_oylama = db.Column(db.Integer)
